...
public class AccessFile 
{
	...
	private static BtreeNode checkexistance(String keyword,int index)
	{
		return btreerootarray[index].search(keyword);
	}
	public static void addkeyword(String keyword, double weight, String url)
	{
	...
	public static String urlindexfile(String url)
	{
	...
	public static void makesrcfile(String index, String t)
	{
		try
		{
	...
	public static void makebtreefile(String output,int mode)
	{
		String path = new String("./btree files/");
		String filename;
		if(mode == 0)
	...
	public static void zoneindexfiles(ZoneIndexing table,String index)
	{
	...
	public static File fetchzone(String index)
	{

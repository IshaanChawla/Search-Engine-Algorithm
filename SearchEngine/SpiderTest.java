...
public class SpiderTest
{
    public static void main(String[] args)
    {
        ...
        spider.crawl("http://www.codingunit.com/category/c-tutorials");
        spider.crawl("http://www.cplusplus.com/doc/tutorial/");
        spider.crawl("http://www.learn-c.org/");
        spider.crawl("http://www.programiz.com/c-programming");
        spider.crawl("http://fresh2refresh.com/cprogramming/");
        spider.crawl("http://php.net/manual/en/tutorial.php");
        spider.crawl("http://www.tizag.com/");
        spider.crawl("http://www.homeandlearn.co.uk/php/php.html");
        spider.crawl("http://www.freewebmasterhelp.com/tutorials/php");
    }
}